...
import Discovercourses from '../components/header/discover';
import "../screens/styles/userProfile.css";
import { UserInterface } from '../interface/userInterface';

function UserprofileScreen(props:{modalResponse:(message:string,type:string)=> void}){
    ...
    const saveData = (modalResponse: boolean)=>{
        ...
        if(modalResponse){
            props.modalResponse("Your profile is saved!","success")
        }
    }
    ...
    return(
        <div className="container">
            <Discovercourses
              ...
              message = "My Profile"               
            />
            <div className="profile-outercontainer" style={{display:"flex"}}>
                <div className="profile-pic-container w-25">
                    <img src="/files/images/Profile-pic.png" alt="profile pic" />
                </div>
                <div className="profile-details-container" >
                    <form>
                        <div className="profile-name-container" style={{display:"flex"}} >
